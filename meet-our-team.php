...
$query_Recordset1 = "SELECT * FROM photos WHERE albumID = ".$albumID." ORDER BY photoSequence, photoTitle ASC";
...
<!-- main content -->
<div class="content">
<!-- InstanceBeginEditable name="mainContent" --> <div class="header">
  ...
  <div class="main"> <?php echo $row_currentPage['pageContent']; ?>
...
<!-- grid -->
  ...
  <?php do { ?>
  <div class="item">
      <a href="listings-agents.php?agentName=<?php echo $row_Recordset1['photoTitle']; ?>"><div class="overlay-item">
		...
		?>
        <a class="button wf_text_center" href="listings-agents.php?agentName=<?php echo $row_Recordset1['photoTitle']; ?>">View my listings</a>
      </div></a>
    </div>
